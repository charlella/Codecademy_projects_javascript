class Media {
    ...
    toggleCheckedOutStatus() {
      ...
      //pas de _ après this. car on utilise celui du setter ligne 20
      // !this veut dire "not this"
    }
  
    getAverageRating() {
      let ratingsSum = this.ratings.reduce((accumulator, ratng) => accumulator + rating);
  ...
  //A partir Q9 : class BOOK, en dehors  class Media
  ...
  //A partir Q14 class MOVIE, en dehors class Media
  ...
  historyOfEverything.addRating(5);
  //Q19 marche pas : console.log(historyOfEverything.getAverageRating());
